...
## 2.Get the total number of requests for each complaint type ('complaint_type'), \
##and plot a pie chart depicting the % share of each top five complaint type vs the rest within the total activity.
